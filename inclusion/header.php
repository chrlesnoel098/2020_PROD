            ...
            <div class="menu-menu-1-container">
                <ul id="primary-menu" class="menu nav-menu">
                    ...
                    <li><a target="_blank" href="https://www.instagram.com/maisonneuvetim/"><img
                                src="images/icone-instagram.png" alt=""></a></li>
                    <li><a target="_blank" href="https://www.youtube.com/user/TIMaisonneuve"><img
                                src="images/icone-youtube.png" alt=""></a></li>
                    <li><a target="_blank" href="https://discord.com/invite/53vFvr9"><img src="images/icone-discord.png"
                                alt=""></a></li>
                </ul>
            </div>
        </nav>
