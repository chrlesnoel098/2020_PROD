...
<head>
    ...
    <meta name="keywords" content="TIM, Techinque, d'Intégration, multimédia, collège, Maisonneuve">
    <meta name="author" content="Charles Noël, Bernard Dwyer, Alejandra Miranda, Lauryan Gervais">
            ...
            <nav id="site-navigation" class="main-navigation">
                ...
                <div class="menu-menu-1-container">
                    <ul id="primary-menu" class="menu nav-menu">
                        ...
                        <li><a class="links" href="#" aria-current="page">
                                <div class="progress"></div>
                                <div class="cube-wrap">
                                    <div class="cube">
